...
public class BlogController {
    ...
    public ModelAndView goToNewBlogForm() {
        ModelAndView modelAndView = new ModelAndView("blog/newBlogForm");
    ...
    public ModelAndView viewBlog(@PathVariable int id) {
        ...
        ModelAndView modelAndView = new ModelAndView("blog/viewBlogForm");
    ...
    public ModelAndView goToBlogEditForm(@PathVariable int id) {
        Blog selectedBlog = blogService.findById(id);
        ModelAndView modelAndView = new ModelAndView("blog/editBlogForm");
        modelAndView.addObject("blog", selectedBlog);
        return modelAndView;
    }
    ...
    public ModelAndView goToBlogDeleteForm(@PathVariable int id) {
        Blog selectedBlog = blogService.findById(id);
        ModelAndView modelAndView = new ModelAndView("blog/deleteBlogForm");
        modelAndView.addObject("blog", selectedBlog);
        return modelAndView;
    }
